Spree::Product.class_eval do
  ...
  Rails.application.config.after_initialize do
    ...
    searchkick index_name: "#{Rails.application.class.module_parent_name.parameterize.underscore}_spree_products_#{Rails.env}", word_start: [:name] unless Spree::Product.try(:searchkick_options)
  end
